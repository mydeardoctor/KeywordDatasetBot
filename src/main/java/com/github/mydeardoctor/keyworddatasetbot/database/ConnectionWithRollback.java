...
public class ConnectionWithRollback implements Connection
{
    ...
    {
        /* Overrided for use with try-with-resources block.
           Rollback should be called before closing the connection. */
