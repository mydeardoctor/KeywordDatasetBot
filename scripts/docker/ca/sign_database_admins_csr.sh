...
if [[ -f "${DATABASE_CERTS_DIRECTORY}/${DATABASE_ADMIN_CSR}" ]]; then
    echo "Moving ${DATABASE_CERTS_DIRECTORY}/${DATABASE_ADMIN_CSR}" \
         "to ${CA_ADMIN_HOME}"
    mv -f \
...
ls -l "${DATABASE_CERTS_DIRECTORY}/${DATABASE_ADMIN_CRT}"
